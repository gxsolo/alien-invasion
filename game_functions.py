...
def check_bullet_alien_colisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
	"""Remove to bullet-alien collisions."""
	# Remove any bullets and aliens that hava collided.
...
def update_aliens(ai_settings, stats, screen, sb, ship, bullets, aliens):
	"""Check if the fleet is at edge, and then update the positions of all aliens in the fleet."""
